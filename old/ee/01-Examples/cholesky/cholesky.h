...
static int check_factorization(const MKL_INT N, double *A1, double *A2, const MKL_INT LDA, char uplo, double eps)
{
...
void initialize_matrix(const MKL_INT n, const int ts, double *matrix)
{
	MKL_INT ISEED[4] = {0,0,0,1};
	const MKL_INT intONE=1;
