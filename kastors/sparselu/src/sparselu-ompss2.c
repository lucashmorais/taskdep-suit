...
void sparselu_par_call(float **BENCH, int matrix_size, int submatrix_size)
{
    int ii, jj, kk;
    {
        ...
        {
#pragma oss task inout(BENCH[kk*matrix_size+kk])
{
            ...
            for (jj=kk+1; jj<matrix_size; jj++)
                ...
                {
#pragma oss task in(BENCH[kk*matrix_size+kk]) inout(BENCH[kk*matrix_size+jj])
{
            ...
            for (ii=kk+1; ii<matrix_size; ii++)
                ...
                {
#pragma oss task in(BENCH[kk*matrix_size+kk]) inout(BENCH[ii*matrix_size+kk])
{
...
#pragma oss task in(BENCH[ii*matrix_size+kk], BENCH[kk*matrix_size+jj]) \
